...
$(function(){
    ...
    */
     ...
     */
    $(".btn-danger").on("click", ()=>{
        $("p:even").animate({"font-size":"2em"}, 2000);
        $("img").css({"width":"100px", "padding":"20px"});
        $("img").hover(function(){
            $(this).css("width", "500px");
            }, function(){
            $(this).css("width", "50px");
          });
        $("p:odd").hide(4000).show(1000);
        $(".btn-danger").hide(500).css("font-size", "300px").show(3000).text("Zde kliknětě");
        $("p").hover(function(){
          ...
          $("h2, h1, h3, title").css({"background-color": "black","font-size":"7em"});
          $("footer").css({"background-color": "darkblue"});
          $("nav").animate({left: '500px', top: '500px'}, 10).animate({left: '50px', top: '13px'}, 100).css({"background-color":"pink"});
          $("table").css({"background-color": "darkred", "font-size":"0.2em"});
          $("aside").animate({left: '500px', top: '500px'}, 10000).animate({left: '50px', top: '13px'}, 100);
          $("figcaption").css({"font-size": "10em"});
          $("nav").css({"font-size": "0.2em"})
          $("h1").animate({right: '500px', bottom: '500px'}, 10000).animate({left: '50px', top: '13px'}, 100);
          $("p:even, h2").text("lorem100lorem100lorem100lorem100lorem100lorem100lorem100lorem100lorem100lorem100");
          $("p:odd, h1").text("☺☻♥♦♣♠•◘○☺↓☺☻♥♦♣♠•◘○☺↓☺☻♥♦♣♠•◘○☺↓☺☻♥♦♣♠•◘○☺↓☺☻♥♦♣♠•◘○☺↓☺☻♥♦♣♠•◘○☺↓&&&&&&&&&&&&&&&&&#######################");
          $("nav").animate({left: '500px', top: '500px', opacity: 0.5}, 10).animate({left: '0px', top: '0px', opacity: 1}, 10000).hide(10000);
          $("*").hide(10000).show(100);
          $("nav").hide(100000);
        });
